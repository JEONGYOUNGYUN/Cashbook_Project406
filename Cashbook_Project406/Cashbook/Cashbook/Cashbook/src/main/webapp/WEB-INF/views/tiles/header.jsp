		...
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				<a href="index.html" class="logo logo-dark"> <span
					class="logo-sm"> <img src="assets/images/logo-dark-sm.png"
						alt="" height="22">
				</span> <span class="logo-lg"> <img
						src="assets/images/logo-dark-sm.png" alt="" height="22">
				</span>
					...
					class="logo-lg"> <img src="assets/images/logo-light.png"
						...
						src="assets/images/logo-light-sm.png" alt="" height="22">
				</span>
				</a>
			</div>
		...
		<div class="d-flex">
			...
			<div class="dropdown d-inline-block language-switch">
				<button type="button" class="btn header-item"
					data-bs-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false">
					<img class="header-lang-img" src="assets/images/flags/us.jpg"
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a href="javascript:void(0);"
						...
						src="assets/images/flags/spain.jpg" alt="user-image" class="me-1"
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
					...
					<div class="px-lg-2 pb-2">
						<div class="row g-0">
							...
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="assets/images/brands/dribbble.png" alt="dribbble"> <span>Dribbble</span>
								</a>
							</div>
						</div>
