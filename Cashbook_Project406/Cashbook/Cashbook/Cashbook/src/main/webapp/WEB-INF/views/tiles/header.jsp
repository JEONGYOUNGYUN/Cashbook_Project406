		...
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				<a href="index.html" class="logo logo-dark"> <span
					class="logo-sm"> <img src="/resources/dist/assets/images/logo-dark-sm.png"
						alt="" height="22">
				</span> <span class="logo-lg"> <img
						src="/resources/dist/assets/images/logo-dark-sm.png" alt="" height="22">
				</span>
			...
			<button type="button"
				...
				<span class="hamburger-icon open"> <span></span> <span></span>
					<span></span>
				</span>
			</button>

			<div class="d-none d-sm-block ms-3 align-self-center">
				<h4 class="page-title">내역</h4>
			</div>
		...
		<div class="d-flex">
						...
						<div class="search-box">
							<div class="position-relative">
								<input type="text" class="form-control bg-light border-0"
									...
									data-eva="search-outline" data-eva-height="26"
									data-eva-width="26"></i>
							</div>
						</div>
					</form>
			...
			<div class="dropdown d-inline-block language-switch">
				<button type="button" class="btn header-item"
					data-bs-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false">
					<img class="header-lang-img" src="/resources/dist/assets/images/flags/us.jpg"
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a href="javascript:void(0);"
						class="dropdown-item notify-item language" data-lang="eng"> <img
						src="/resources/dist/assets/images/flags/us.jpg" alt="user-image" class="me-1"
					...
					<a href="javascript:void(0);"
						...
						src="/resources/dist/assets/images/flags/spain.jpg" alt="user-image" class="me-1"
					...
					<a href="javascript:void(0);"
						...
						src="/resources/dist/assets/images/flags/germany.jpg" alt="user-image"
					...
					<a href="javascript:void(0);"
						...
						src="/resources/dist/assets/images/flags/italy.jpg" alt="user-image" class="me-1"
					...
					<a href="javascript:void(0);"
						...
						src="/resources/dist/assets/images/flags/russia.jpg" alt="user-image" class="me-1"
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
					...
					<div class="px-lg-2 pb-2">
						<div class="row g-0">
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="/resources/dist/assets/images/brands/github.png" alt="Github"> <span>GitHub</span>
								</a>
							</div>
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="/resources/dist/assets/images/brands/bitbucket.png" alt="bitbucket">
									<span>Bitbucket</span>
								</a>
							</div>
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="/resources/dist/assets/images/brands/dribbble.png" alt="dribbble"> <span>Dribbble</span>
								</a>
							</div>
						</div>
						...
						<div class="row g-0">
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="/resources/dist/assets/images/brands/dropbox.png" alt="dropbox"> <span>Dropbox</span>
								</a>
							</div>
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="/resources/dist/assets/images/brands/mail_chimp.png" alt="mail_chimp">
									<span>Mail Chimp</span>
								</a>
							</div>
							<div class="col">
								<a class="dropdown-icon-item" href="#!"> <img
									src="/resources/dist/assets/images/brands/slack.png" alt="slack"> <span>Slack</span>
								</a>
							</div>
						</div>
					</div>
			...
			<div class="dropdown d-inline-block">
				<button type="button" class="btn header-item noti-icon"
					...
					<i class="icon-sm" data-eva="bell-outline"></i> <span
						class="noti-dot bg-danger rounded-pill">4</span>
				</button>
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
							...
							<div class="d-flex">
								...
								<div class="flex-grow-1">
									...
									<div class="font-size-13 text-muted">
										...
										<p class="mb-0">
											<i class="mdi mdi-clock-outline"></i> <span>1 hour ago</span>
										</p>
									</div>
								</div>
							</div>
					...
					<div class="p-2 border-top d-grid">
						<a class="btn btn-sm btn-link font-size-14 btn-block text-center"
							...
							class="uil-arrow-circle-right me-1"></i> <span>View More..</span>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="dropdown d-inline-block">
				<button type="button"
					...
					id="page-header-user-dropdown-v" data-bs-toggle="dropdown"
					aria-haspopup="true" aria-expanded="false">
